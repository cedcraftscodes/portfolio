...
<body>
  ...
  <div class="container-fluid nav-bar">
    <ul class="list-inline" >
      <li class="list-inline-item"><i class="fa fa-briefcase" aria-hidden="true"></i> <a href="#experience">Experience</a></li>
      <li class="list-inline-item"><i class="fa fa-graduation-cap" aria-hidden="true"></i> <a href="#education">Education</a></li>
      <li class="list-inline-item"><i class="fa fa-wrench" aria-hidden="true"></i> <a href="#myskills">My Skills</a></li>
      <li class="list-inline-item"><i class="fa fa-code" aria-hidden="true"></i> <a href="#portfolio">Portfolio</a></li>
      <li class="list-inline-item"><i class="fa fa-phone" aria-hidden="true"></i> <a href="#contacts">Contact</a></li>
